...
tab1 <- tab1 %>%
  mutate(
    ...
    footnote1 = if_else(str_detect(var, "^sos_comdur_af"), footnote_marker_symbol(2), ""),
    footnote2 = if_else(str_detect(tab1$var, paste0("^", modvars, collapse = "|")), footnote_marker_symbol(3), "")
  ) %>%
