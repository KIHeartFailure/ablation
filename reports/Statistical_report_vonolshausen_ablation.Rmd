...
curves and cumulative incidence curves treating death as a competing event for other outcomes. 
...
Repeated events were model using a negative binomial generalized linear model 
...
for in the model, to fully eliminate the association between ablation and all-cause-mortality/first HFH.  

```{r, child = "../src/evalue.Rmd"}

```

See Table \ref{tab:evalue2} in order to compare the magnitude of the E-value 
